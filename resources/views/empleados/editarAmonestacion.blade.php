...
.no-spinners::-webkit-inner-spin-button {
  ...
  margin: 0;
	...
	<form id="formCreate" method="POST" action="{{URL('/amonestacion/'.$amonestacion->id.'/actualizarAmonestacion')}}" enctype="multipart/form-data">
		...
		<div class="form-group">
			<div class="form-row">
			    <div class="col-8">
					...
					<textarea class="form-control" aria-label="With textarea" placeholder="Motivo de amonestacion"  name="motivo" rows="10" >{{ $amonestacion->motivo }}</textarea>
					...
					<div class="row ">
						...
						<div class="col-10 pl-0">
						   <select class="form-control custom-select" name="tipo">
						        <option value="{{$amonestacion->tipo}}" selected="true">{{ $amonestacion->tipo.' (Seleccionado)' }} </option>
		...
		<div class="form-group">
			<div class="form-row">
			    <div class="col-8">
					...
					<textarea class="form-control" aria-label="With textarea" placeholder="Sanción"  name="sancion" rows="10" >{{ $amonestacion->sancion}}</textarea>
			  ...
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h5 class="modal-title" id="exampleModalLabel">Editar amonestacion</h5>
			      ...
			      <div class="modal-footer">
			        ...
			        <button  type="submit" class="btn btn-outline-success" name="submitbtn" value="create" id="submitFinal"><span class="ion-checkmark-round">Guardar Cambios</span></button>
			      </div>
			    </div>
			  </div>
			</div>
			  ...
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-footer">
			        ...
			        <a class="btn btn-outline-danger ion-close-round" href="{{URL('/empleados/show')}}">Si, estoy seguro</a>
			      </div>
			    </div>
			  </div>
			</div>
