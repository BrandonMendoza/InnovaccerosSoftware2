  ...
  margin: 0;
	...
	<nav aria-label="breadcrumb">
	    <ol class="breadcrumb">
	      ...
	      <li class="breadcrumb-item"><a href="{{URL('proveedor/'.$proveedor->id.'/perfil')}}">Perfil {{ $proveedor->nombre }}</a></li>
	...
	<form id="formCreate" method="POST" action="{{route('actualizarProveedor')}}" enctype="multipart/form-data">
							...
							<div class="input-group mb-3">
								...
								<div class="row mt-2">
								  	<div style="width: 200px; height: 150px;" class="img-thumbnail form-control">
										<img id="blah" src="{{ asset('uploads/DocProveedores/'.$proveedor->foto) }}" alt="your image" style="width: 100%; height: 100%;"/>
									</div>
								</div>
							</div>
						</div>
			    ...
			    <div class="col-8">
					<div class="row">
						...
						<div class="col-9 pl-0">
						    <input id="nombre" name="nombre" class="form-control ml-0" type="text" placeholder="Nombre" value="{{ $proveedor->nombre }}">
						    @if($errors->any())
			...
			<div class="form-row">
			    <div class="col-8">
					<div class="row">
						...
						<div class="col-9 pl-0">
						    <input id="sucursal" name="sucursal" class="form-control ml-0" type="text" placeholder="Sucursal" value="{{ $proveedor->sucursal }}">
						    @if($errors->any())
			...
			<div class="form-row">
			    <div class="col-8">
					<div class="row">
						...
						<div class="col-9 pl-0">
						    <input id="telefono" name="telefono" class="form-control" type="text" placeholder="5555555" value="{{ $proveedor->telefono }}">
						    @if($errors->any())
			...
			<div class="form-row">
			    <div class="col-8">
					<div class="row">
						...
						<div class="col-9 pl-0">
						    <input id="email" name="email" class="form-control" type="text" placeholder="email@gmail.com" value="{{ $proveedor->email }}">
						    @if($errors->any())
					...
					<div class="row">
						...
						<div class="col-9 pl-0">
						    <select class="form-control custom-select" name="categoria">
						        <option value="{{ $proveedor->categoria }}" selected="true">{{ $proveedor->categoria }}</option>
		...
		<div class="form-group">
			<div class="form-row">
			    <div class="col-8">
					<label >notas : </label>
					<textarea class="form-control" aria-label="With textarea" placeholder="Notas"  name="notas" rows="7" value="">{{ $proveedor->notas }}</textarea>
					@if($errors->any())
			  ...
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			      	Estas seguro que deseas editar esta Proveedor?
			      </div>
			      <div class="modal-footer">
			        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
			        <button  type="submit" class="btn btn-outline-success" name="submitbtn" value="create" id="submitFinal"><span class="ion-checkmark-round">Gaurdar</span></button>
			      </div>
			    </div>
			  </div>
			</div>
			  ...
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-footer">
			        ...
			        <a class="btn btn-outline-danger ion-close-round" href="{{URL('proveedor/'.$proveedor->id.'/perfil')}}">Si, estoy seguro</a>
			      </div>
			    </div>
			  </div>
			</div>
