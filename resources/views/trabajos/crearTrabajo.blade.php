          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            	<li class="breadcrumb-item"><a href="{{URL('/')}}">Inicio</a></li>
	      		...
	      		<li class="breadcrumb-item">Agregar Proyecto</li>
            </ol>
          </div>
        </div>
      </div>
...
.no-spinners::-webkit-inner-spin-button {
  ...
  margin: 0;
	...
	<form id="formCreate" method="POST" action="{{URL('/trabajo/insertar')}}" enctype="multipart/form-data" name="agregarProyecto">
      {{csrf_field()}}
      ...
      <div class="row">
          	...
          	<div class="card card-default">
	            ...
	            <div class="card-body" style="display: block;">
	              	...
	              	<div class="form-group">
	                	...
	                	<input type="text"  name="nombre_trabajo" id="nombre_trabajo" class="form-control" value="{{ old('nombre') }}" >
	              	</div>
	              	<div class="form-group">
		                <label for="cliente">Cliente </label>
		                 <select class="form-control custom-select" id="cliente" name="id_cliente">
			                <option value="0" selected="true">-Cliente-</option>
	    	...
	    	<div class="card card-default">
	            ...
	            <div class="card-body" style="display: block;">
	            	<div class="row">
		                ...
		                <div class="col-sm-6">
		                  	<div class="form-group">
								...
								<input type="number"  id="tiempo_pago" name="tiempo_pago" class="form-control no-spinners" onkeypress="return isNumberKey(event)">
			            	</div>
		                </div>
		            </div>
	            	...
	            	<div class="form-group">
	                	...
	                	<textarea id="valides" name="valides" class="form-control" type="text"></textarea>
	            	</div>
	            	<div class="form-group">
	    ...
	    <div class="row">
	        <div class="col-12">
	        	...
	        	<button type="submit" value="cotizar" class="btn btn-flat btn-success float-right">
	          		Agregar y cotizar<i class="fas fa-arrow-right ml-2"></i>
	        	</button>

	        	<button type="submit" value="create" class="btn btn-flat btn-success float-right mr-2">
	          		<i class="fas fa-check-square mr-2"></i>Agregar y salir
	        	</button>
	        </div>
	    </div>
</form>
