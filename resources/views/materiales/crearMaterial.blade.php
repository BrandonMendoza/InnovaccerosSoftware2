...
@section('content')
	...
	<form id="formCreate" method="POST" action="{{route('insertarMaterial')}}" enctype="multipart/form-data">
		<div class="row">
			<div class="col-3">
			...
			<div class="form-row">
				<div class="col">
					...
					<div class="row mt-2">
						...
						<div class="col-10">
							<input id="medidas" name="medidas" class="form-control" type="text" placeholder="4x4X4">
						</div>
					    @if($errors->any())
						    @foreach($errors->get('descripcion') as $error)
								<div class="badge badge-pill badge-danger">{{ $error }}</div>
