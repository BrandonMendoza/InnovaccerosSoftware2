...
@section('content')
	...
	<form id="formCreate" method="POST" action="{{ URL('/cliente/'.$cliente->id.'/actualizarCliente') }}" enctype="multipart/form-data" name="editarCliente">
      {{csrf_field()}}
      <div class="row">
        <div class="col-md-6">
          	<div class="card card-default">
	            ...
	            <div class="card-body" style="display: block;">
	              	...
	              	<div class="form-group">
	                	...
	                	<input type="text" id="nombre_cliente" class="form-control" name="nombre_cliente" value="{{ $cliente->nombre_cliente }}">
	              	</div>
	              	<div class="form-group">
	    			    <label for="giro">Giro </label>
						<input id="giro" name="giro" class="form-control" type="text" value="{{ $cliente->giro }}">
		            </div>
	              	<div class="form-group">
	                	<label for="tel_oficinas">Telefono de Oficina</label>
	                	
	                	<div class="input-group">
	                		<input type="text"  id="tel_oficinas" name="tel_oficinas" class="form-control" value="{{ $cliente->tel_oficinas}}">
	    	...
	    	<div class="card card-default">
	            ...
	            <div class="card-body" style="display: block;">
	            	...
	            	<div class="form-group">
						...
						<input id="razon_social" name="razon_social" class="form-control" type="text" value="{{ $cliente->razon_social }}">
		            </div>
	              	<div class="form-group">
	                	<label for="rfc">RFC </label>
	                	<input type="text" id="rfc" class="form-control" name="rfc" value="{{ $cliente->rfc }}">
	              	</div>
	              	<div class="form-group">
	                	<label for="direccion">Dirección</label>
	                	<input type="text" id="direccion" class="form-control" name="direccion" class="form-control" value="{{ $cliente->direccion }}">
	            	</div>
	            	<div class="form-group">
	                	<label for="codigo_postal">Codigo Postal</label>
	                	<input type="text" id="codigo_postal" class="form-control" name="codigo_postal" class="form-control" value="{{ $cliente->codigo_postal }}">
	            	</div>
	            </div>
            <!-- /.card-body -->
	        </div>
